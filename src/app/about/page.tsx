...
export default function AboutPage() {
    return (
        <div className="bg-white min-h-screen pb-20">
            {/* Header */}
            <div className="bg-secondary text-white py-20 px-4 md:py-32 relative overflow-hidden">
                ...
                <div className="container mx-auto max-w-4xl relative z-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <Badge variant="outline" className="border-blue-400/30 text-blue-200 mb-6 font-medium">About ProcessCraft Digital</Badge>
            ...
            <div className="container mx-auto px-4 -mt-16 relative z-20">
                <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8 md:p-12 mb-20 animate-in slide-in-from-bottom-8 duration-1000 delay-100">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-2xl font-bold text-secondary mb-4">Our Origin Story</h2>
                ...
                <div className="max-w-6xl mx-auto mb-20">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-secondary">What We Believe In</h2>
                    </div>
                ...
                <div className="max-w-4xl mx-auto mb-20">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-secondary mb-4">Our Approach</h2>
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="flex items-start md:items-center gap-6 p-6 bg-white rounded-xl border border-gray-100 hover:border-blue-100 transition-colors">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-secondary">{phase.title}</h3>
                ...
                <div className="bg-secondary rounded-3xl p-12 text-center text-white max-w-4xl mx-auto relative overflow-hidden">
                    <div className="relative z-10">
                        <h2 className="text-2xl font-bold mb-4">Certifications & Partnerships</h2>
